  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 selection:bg-purple-500/30 font-sans overflow-x-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-20%] left-[-10%] w-[70%] h-[70%] bg-purple-500/[0.03] blur-[150px] rounded-full animate-pulse" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-purple-600/[0.03] blur-[150px] rounded-full animate-pulse [animation-delay:2s]" />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4 group cursor-pointer">
            ...
            <div className="flex flex-col">
              <h1 className="text-lg font-bold tracking-tight text-white font-outfit leading-none">{process.env.NEXT_PUBLIC_BRAND_NAME || "Weirdos Shield"}</h1>
              <span className="text-[9px] font-black uppercase tracking-[0.2em] text-purple-500/80 mt-1">Dashboard</span>
            </div>
          </div>

          <div className="hidden lg:flex items-center gap-10 text-[11px] font-black uppercase tracking-widest text-slate-500">
            <Link href="#features" className="hover:text-purple-500 transition-colors">Features</Link>
            <Link href="#architecture" className="hover:text-purple-500 transition-colors">Architecture</Link>
            <Link href="#modules" className="hover:text-purple-500 transition-colors">Modules</Link>
            <Link href="#network" className="hover:text-purple-500 transition-colors">Network</Link>
          </div>
      ...
      <header className="relative z-10 pt-56 pb-32 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-3 px-6 py-2.5 rounded-2xl bg-purple-500/[0.03] border border-purple-500/10 text-purple-500 text-[10px] font-black uppercase tracking-[0.3em] mb-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 backdrop-blur-md">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300">
            <Button 
              onClick={() => signIn('discord', { callbackUrl: '/dashboard' })}
              className="w-full sm:w-auto rounded-2xl px-14 py-9 text-lg font-black uppercase gap-4 group shadow-[0_0_50px_rgba(239,68,68,0.2)] bg-purple-600 text-white hover:bg-purple-500 border-none transition-all hover:scale-105"
            >
        ...
        <div className="max-w-6xl mx-auto mt-40 relative group animate-in fade-in zoom-in-95 duration-1000 delay-500">
           <div className="absolute -inset-4 bg-gradient-to-r from-purple-600 to-indigo-600500/20 to-transparent rounded-[60px] blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
           <div className="relative bg-[#020617] border border-white/[0.05] rounded-[50px] overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.8)]">
              ...
              <div className="h-16 border-b border-white/[0.03] flex items-center justify-between px-10 bg-white/[0.01]">
                <div className="flex items-center gap-3">
                  <div className="h-3 w-3 rounded-full bg-purple-500/40" />
              ...
              <div className="aspect-[16/10] p-16 flex flex-col gap-16 relative overflow-hidden bg-gradient-to-br from-[#020617] to-[#0a0f1e]">
                <div className="flex items-center justify-between z-10 relative">
                  <div className="space-y-6">
                    <div className="h-12 w-64 bg-purple-500/10 rounded-[20px] border border-purple-500/20" />
                    <div className="h-6 w-[500px] bg-white/[0.02] rounded-xl" />
                  </div>
                  <div className="h-20 w-20 rounded-[30px] bg-purple-500/10 border border-purple-500/20 flex items-center justify-center shadow-[0_0_30px_rgba(239,68,68,0.2)]">
                    <Activity className="h-8 w-8 text-purple-500 animate-pulse" />
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-10 z-10">
                  {[1, 2, 3].map(i => (
                    <div key={i} className="h-40 bg-white/[0.02] border border-white/[0.04] rounded-[40px] p-8 space-y-6 hover:border-purple-500/20 transition-colors">
                      <div className="h-10 w-10 rounded-2xl bg-purple-500/10 border border-purple-500/20" />
                ...
                {/* Visual Glow Layer */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] h-[90%] bg-purple-500/[0.02] blur-[150px] pointer-events-none" />
              </div>
           </div>
        </div>
      </header>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-32 gap-12 px-4">
            ...
            <div className="flex items-center gap-10 pb-4">
               <div className="text-right">
                 ...
                 <p className="text-5xl font-black text-purple-500 font-outfit">12ms</p>
               </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { 
                ...
                icon: History,
                color: "bg-purple-800/10 border-purple-800/20 text-purple-700"
              },
              { 
              ...
              <div key={i} className="group glass border-white/5 p-12 rounded-[50px] hover:border-purple-500/30 transition-all duration-700 relative overflow-hidden">
                ...
                <div className="mt-8 h-[2px] w-0 bg-purple-500 group-hover:w-full transition-all duration-700" />
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="architecture" className="py-48 px-6 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
           <div className="space-y-12">
              <div className="inline-flex px-4 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-500 text-[10px] font-black uppercase tracking-[0.3em]">
                 The Stack
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-8">
                 {[
                   { icon: Terminal, title: "Custom DSL", desc: "Write advanced logic with our intuitive Weirdos Shield scripting language." },
           ...
           <div className="relative aspect-square flex items-center justify-center group">
              ...
              <div className="h-[80%] w-[80%] border-2 border-white/[0.05] rounded-full animate-[spin_60s_linear_infinite] flex items-center justify-center relative">
                 <div className="absolute top-0 left-1/2 -translate-x-1/2 h-4 w-4 rounded-full bg-purple-500 shadow-[0_0_20px_rgba(239,68,68,0.5)]" />
                 <div className="h-[70%] w-[70%] border border-white/[0.05] rounded-full animate-[spin_40s_linear_infinite_reverse] flex items-center justify-center">
                    ...
                    <div className="h-[60%] w-[60%] border border-white/[0.05] rounded-full animate-[spin_20s_linear_infinite] flex items-center justify-center">
                       <Bot className="h-20 w-20 text-purple-500/40 group-hover:text-purple-500 transition-all duration-700 group-hover:scale-125" />
                    </div>
                 </div>
              </div>
           </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="group p-8 rounded-[40px] bg-white/[0.01] border border-white/[0.03] hover:bg-purple-500/[0.02] hover:border-purple-500/20 transition-all duration-500">
                 <div className="h-14 w-14 rounded-2xl bg-white/[0.03] flex items-center justify-center mb-6 group-hover:bg-purple-500/10 transition-colors">
                    <mod.icon className="h-6 w-6 text-slate-600 group-hover:text-purple-500 transition-colors" />
                 </div>
      ...
      <section id="network" className="py-48 px-6 bg-purple-600/[0.01] relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
           <div className="flex flex-col lg:flex-row items-center gap-24">
              <div className="flex-1 space-y-12">
                 <h2 className="text-6xl md:text-8xl font-bold text-white tracking-tighter font-outfit uppercase">Global <br /><span className="text-purple-500">Reach.</span></h2>
                 ...
                 <div className="space-y-8">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-8">
                         ...
                         <div className="text-[11px] font-black uppercase text-purple-500 tracking-[0.3em]">{item.label}</div>
                      </div>
                    ))}
                 </div>
              </div>
              <div className="flex-1 relative group">
                 <div className="absolute inset-0 bg-purple-500/10 blur-[150px] opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
                 <div className="aspect-square bg-[#020617] border border-white/[0.05] rounded-[60px] p-12 relative overflow-hidden flex items-center justify-center">
                    <Globe className="h-64 w-64 text-purple-500/10 animate-pulse" />
                    <div className="absolute inset-0 flex items-center justify-center">
                       <div className="h-32 w-32 bg-purple-500/20 blur-[60px] rounded-full" />
                    </div>
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 space-y-12">
                       <Bot className="h-20 w-20 text-purple-500 shadow-[0_0_50px_rgba(239,68,68,0.5)] bg-[#020617] rounded-3xl p-4 border border-purple-500/50" />
                    </div>
                 </div>
              </div>
           </div>
      ...
      <section className="py-48 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              { q: "Is the Weirdos Shield Engine free to use?", a: "The core engine is 100% free for all communities. We offer premium clusters for ultra-high-scale enterprise servers." },
              ...
              <div key={i} className="p-10 rounded-[40px] border border-white/[0.03] hover:border-white/10 transition-all bg-white/[0.01] group">
                 <h4 className="text-xl font-bold text-white mb-6 font-outfit uppercase tracking-tight flex items-center gap-4">
                    <div className="h-2 w-2 rounded-full bg-purple-500 opacity-20 group-hover:opacity-100 transition-all" />
                    {item.q}
                 </h4>
      ...
      <section className="py-48 px-6">
        <div className="max-w-6xl mx-auto relative rounded-[80px] p-24 md:p-32 overflow-hidden bg-gradient-to-br from-purple-600 to-indigo-600600 to-rose-900 text-center shadow-[0_40px_100px_rgba(0,0,0,0.6)]">
           ...
           <div className="relative z-10">
              ...
              <p className="text-2xl text-white/70 max-w-3xl mx-auto mb-20 font-medium">Join 5,000+ communities scaling their automation with the Weirdos Shield Engine. Setup takes less than 30 seconds.</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-32">
            <div className="col-span-1 md:col-span-2 space-y-12">
              <div className="flex items-center gap-4 group">
                <span className="text-3xl font-bold text-white font-outfit uppercase tracking-tighter">{process.env.NEXT_PUBLIC_BRAND_NAME || "Weirdos Shield"} Engine</span>
              </div>
            ...
            <div className="space-y-8">
               ...
               <ul className="space-y-5 text-[11px] font-black uppercase tracking-widest text-slate-500">
                  <li><Link href="#" className="hover:text-purple-500 transition-colors">GitHub Repository</Link></li>
                  <li><Link href="/docs" className="hover:text-purple-500 transition-colors">Documentation</Link></li>
                  <li><Link href="#" className="hover:text-purple-500 transition-colors">API References</Link></li>
               </ul>
            </div>
            <div className="space-y-8">
               <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-white opacity-40">Identity</h4>
               <ul className="space-y-5 text-[11px] font-black uppercase tracking-widest text-slate-500">
                  <li><Link href="/privacy" className="hover:text-purple-500 transition-colors">Privacy Shield</Link></li>
                  <li><Link href="/terms" className="hover:text-purple-500 transition-colors">Terms of Service</Link></li>
                  <li><Link href="#" className="hover:text-purple-500 transition-colors">Discord Server</Link></li>
               </ul>
            </div>
          </div>
          <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 opacity-40">
            <p className="text-slate-700 text-[10px] font-black uppercase tracking-[0.4em]">
              © 2026 {process.env.NEXT_PUBLIC_BRAND_NAME || "Weirdos Shield"} Development // Advanced Neural Infrastructure.
            </p>
            <div className="flex items-center gap-8">
               <div className="flex items-center gap-3 text-[10px] font-black text-purple-500 uppercase tracking-[0.3em]">
