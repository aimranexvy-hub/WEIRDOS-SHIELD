  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 px-2">
        <div>
          <h1 className="text-4xl md:text-5xl font-bold text-white font-outfit tracking-tight">System <span className="text-purple-500 italic">Core.</span></h1>
          <p className="text-slate-400 mt-3 font-medium flex items-center gap-2">
            Status and live metrics for <span className="text-purple-500 font-bold px-2 py-0.5 rounded-lg bg-purple-500/10 border border-purple-500/20">{botInfo.name}</span>
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => (
          <div key={stat.name} className="group glass border-white/5 p-7 rounded-[32px] relative overflow-hidden hover:border-purple-500/30 transition-all duration-500 shadow-2xl">
              {/* Animated Glow Overlay */}
              <div className="absolute inset-0 bg-gradient-to-br from-purple-600 to-indigo-600500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
             ...
             <div className="flex items-center justify-between relative z-10">
                ...
                <div className="p-4 bg-purple-500/10 rounded-2xl border border-purple-500/20 group-hover:scale-110 group-hover:bg-purple-500/20 transition-all duration-500">
                  <stat.icon className="h-6 w-6 text-purple-500" />
                </div>
             </div>
             
             <div className="absolute bottom-0 left-12 right-12 h-[1px] bg-purple-500/50 blur-[1px] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 glass border-white/5 rounded-[40px] p-10 relative group overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center justify-between mb-8 relative z-10">
            ...
            <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20">
               ...
               <span className="text-[10px] font-black text-purple-500 uppercase tracking-widest">Efficiency</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10">
            {[
              ...
              { title: "Documentation", desc: "Learn how to master the Weirdos Shield engine.", icon: FileText, href: "#" },
            ].map((item) => (
              <a key={item.title} href={item.href} className="flex items-center gap-5 p-4 rounded-2xl bg-white/[0.02] border border-white/[0.03] group/item hover:bg-white/[0.05] hover:border-purple-500/20 transition-all">
                <div className="h-12 w-12 rounded-2xl bg-purple-500/5 border border-purple-500/10 flex items-center justify-center group-hover/item:bg-purple-500/10 transition-colors">
                   <item.icon className="h-5 w-5 text-purple-500/60 group-hover/item:text-purple-500 transition-colors" />
                </div>
                <div>
                  <h4 className="text-sm font-bold text-white group-hover/item:text-purple-500 transition-colors">{item.title}</h4>
        ...
        <div className="glass border-white/5 rounded-[40px] p-10 flex flex-col justify-between relative group shadow-2xl overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-bl from-purple-600 to-indigo-600500/[0.05] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
          
          <div className="relative z-10">
            <h2 className="text-2xl font-bold text-white mb-3 font-outfit">Module Status</h2>
            <p className="text-slate-500 text-sm mb-10 font-medium">Global operational health of Weirdos Shield core.</p>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={service.name} className="flex items-center justify-between p-4 bg-white/[0.02] rounded-2xl border border-white/[0.05] hover:border-purple-500/20 transition-colors">
          ...
          <div className="absolute -bottom-10 -right-10 h-32 w-32 bg-purple-500/10 blur-3xl rounded-full" />
        </div>
      </div>
    </div>
  );
