          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <p className="text-[11px] text-slate-400 leading-relaxed">
                <span className="text-slate-200 font-bold">Hierarchy Matter:</span> Ensure Weirdos Shield&apos;s top role is <span className="text-primary italic">higher</span> than any role you select here.
              </p>
            </div>
            <div className="flex gap-3">
              <div className="h-1.5 w-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
